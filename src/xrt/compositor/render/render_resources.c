...
XRT_CHECK_RESULT static VkResult
create_gfx_mesh_descriptor_set_layout(struct vk_bundle *vk,
                                      uint32_t ubo_binding,
                                      uint32_t src_binding,
                      ...
                      struct xrt_device *xdev)
{
	...
	r->mesh.camera_src_binding = 1;
	r->mesh.ubo_binding = 2;
...

	{
		...
		struct vk_descriptor_pool_info mesh_pool_info = {
		    ...
		    .sampler_per_descriptor_count = 2,
	...
	ret = create_gfx_mesh_descriptor_set_layout( //
	    vk,                                      // vk_bundle
	    r->mesh.ubo_binding,                     // ubo_binding
	    r->mesh.src_binding,                     // src_binding
	    r->mesh.camera_src_binding,              // camera_src_binding
	    &r->mesh.descriptor_set_layout);         // out_mesh_descriptor_set_layout
	VK_CHK_WITH_RET(ret, "create_gfx_mesh_descriptor_set_layout", false);
