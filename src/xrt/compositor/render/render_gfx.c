                                  ...
                                  VkDescriptorSet descriptor_set)
{
	...
	VkDescriptorImageInfo camera_image_info = {
	...
	VkWriteDescriptorSet write_descriptor_sets[3] = {
	    ...
	    },
	    {
	        .sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET,
	        .dstSet = descriptor_set,
	        .dstBinding = camera_src_binding,
	        .descriptorCount = 1,
	        .descriptorType = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
	        .pImageInfo = &camera_image_info,
	    },
	    {
	        .sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET,
	        .dstSet = descriptor_set,
	...
	uint32_t descriptor_write_count = ARRAY_SIZE(write_descriptor_sets);
	if (camera_src_binding == UINT32_MAX) {
		descriptor_write_count = 2;
		write_descriptor_sets[1] = write_descriptor_sets[2];
	}

	vk->vkUpdateDescriptorSets(    //
	    vk->device,                //
	    descriptor_write_count,    // descriptorWriteCount
...
do_ubo_and_src_alloc_and_write(struct render_gfx *render,
                               ...
                               uint32_t camera_src_binding,
                               VkSampler camera_src_sampler,
                               VkImageView camera_src_image_view,
                                          ...
                                          VkDescriptorSet *out_descriptor_set)
{
	...
	return do_ubo_and_src_alloc_and_write(         //
	    ...
	    src_sampler,                               //
	    src_image_view,                            //
	    UINT32_MAX,                                // camera_src_binding
	    VK_NULL_HANDLE,                            // camera_src_sampler
	    VK_NULL_HANDLE,                            // camera_src_image_view
	    r->gfx.ubo_and_src_descriptor_pool,        //
